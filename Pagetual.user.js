...
(function () {
  ...
  const langData = [
    {
      ...
      lang: {
        ...
        manualMode:
          "Disable splicing, manually turn pages with the right arrow keys (or dispatch event 'pagetual.next')",
    ...
    },
    {
      ...
      lang: {
        ...
        enableHistoryAfterInsert:
          "スプライシングの直後に履歴レコードを書き込みます。それ以外の場合は、閲覧後に書き込みます",
        ...
        clickMode:
          "スティッチングを無効にします。ページの最後までスクロールすると、次のページが自動的にクリックされます",
        ...
        duplicate:
          "Pagetual の重複インストールが検出されました。他のスクリプト マネージャで永続的なページ マシンを削除してください!",
    ...
    },
    {
      ...
      lang: {
        ...
        customRules:
          "Введите пользовательские правила в формате Pagetual. <a href='#t#'>Улучшить встроенные правила</a>",
        ...
        manualMode:
          "Отключить автоматическую загрузку страниц. Загружать вручную с помощью стрелки вправо (или вызова события 'pagetual.next')",
        clickMode:
          'Отключить "сшивание" страниц. При прокрутке до конца автоматически переходить на следующую страницу',
        ...
        duplicate:
          "Похоже, Pagetual установлен несколько раз. Пожалуйста, удалите Pagetual из других менеджеров скриптов!",
  ...
  const storage = {
    ...
    supportGMPromise:
      ...
      typeof GM.getValue("a", "b").then == "function",
  ...
  const ruleImportUrlReg =
    /greasyfork\.org\/.*scripts\/438684(\-[^\/]*)?(\/discussions|\/?$|\/feedback)|github\.com\/hoothin\/UserScripts\/(tree\/master\/Pagetual|issues)/i;
  const allOfBody = "body>*";
  const mainSel = "article,.article,[role=main],main,.main,#main";
  const nextTextReg1 = new RegExp(
    "\u005e\u7ffb\u003f\u005b\u4e0b\u540e\u5f8c\u6b21\u005d\u005b\u4e00\u30fc\u0031\u005d\u003f\u005b\u9875\u9801\u5f20\u5f35\u005d\u007c\u005e\u006e\u0065\u0078\u0074\u005b\u0020\u005f\u002d\u005d\u003f\u0070\u0061\u0067\u0065\u005c\u0073\u002a\u005b\u203a\u003e\u2192\u00bb\u005d\u003f\u0024\u007c\u6b21\u306e\u30da\u30fc\u30b8\u007c\u005e\u6b21\u3078\u003f\u0024\u007cВперед",
    "i"
  );
  const nextTextReg2 = new RegExp(
    "\u005e\u0028\u005b\u4e0b\u540e\u5f8c\u6b21\u005d\u005b\u4e00\u30fc\u0031\u005d\u003f\u005b\u7ae0\u8bdd\u8a71\u8282\u7bc0\u4e2a\u500b\u5e45\u005d\u007c\u006e\u0065\u0078\u0074\u002e\u003f\u0063\u0068\u0061\u0070\u0074\u0065\u0072\u0029\u0028\u005b\u003a\uff1a\u005c\u005c\u002d\u005f\u2014\u0020\u005c\u005c\u002e\u3002\u003e\u0023\u00b7\u005c\u005c\u005b\u3010\u3001\uff08\u005c\u005c\u0028\u002f\u002c\uff0c\uff1b\u003b\u2192\u005d\u007c\u0024\u0029",
    "i"
  );
  const lazyImgAttr = [
    "data-lazy-src",
  ...
  const escapeHTMLPolicy =
    _unsafeWindow.trustedTypes && _unsafeWindow.trustedTypes.createPolicy
  ...
  class RuleParser {
    ...
    ruleMatchReady(r) {
      ...
      if (r.pageElement) {
        let pageElementSel = r.pageElement,
          pageElement;
        ...
        if (urlReg.test(href)) {
          ...
          if (r.waitElement) {
            ...
            if (isNaN(r.wait)) {
              try {
                checkEval =
                  typeof _unsafeWindow.pagetualWait == "undefined"
                    ? Function("doc", '"use strict";' + r.wait)
                    : _unsafeWindow.pagetualWait;
              } catch (e) {
          ...
          if (singleUrl == rule.url) {
            ...
            callback = () => {
              if (self.curSiteRule && !self.curSiteRule.singleUrl) {
                self.smartRules = self.smartRules.filter((item) => {
                  return item && item.url != singleUrl;
                });
    ...
    addToHpRules(instead) {
      try {
        ...
        let url = this.curSiteRule && this.curSiteRule.url,
          self = this;
        let href = location.href.slice(0, 500);
        let matchedRules = this.hpRules.filter(
          (rule) => rule != self.curSiteRule && new RegExp(rule.url, "i").test(href) && self.ruleMatch(rule)
        );
        ...
        this.hpRules = this.hpRules.filter((item) => {
          return (
            item && !matchedRules.find((rule) => item.url == rule.url && JSON.stringify(item) == JSON.stringify(rule))
          );
        });
        if (instead) {
    ...
    getValidHeight(ele, win) {
      ...
      let moreChild = ele.children[0],
        minOffsetTop = maxNum;
      while (moreChild) {
        if (
          (moreChild.offsetParent == ele || moreChild.offsetParent == ele.offsetParent) &&
          moreChild.offsetTop < minOffsetTop
        ) {
    ...
    getPageElement(doc, curWin, dontFind) {
      ...
      if (
        this.curSiteRule.singleUrl &&
        pageElement &&
        pageElement.length > 0 &&
        /^TR$/i.test(pageElement[0].nodeName)
      ) {
        let mainTr = this.insert.parentNode.querySelectorAll("tr"),
          mainTdNum = 0,
          newTdNum = 0;
      ...
      if (
        (this.curSiteRule.singleUrl || !this.curSiteRule.pageElement) &&
        (!pageElement || pageElement.length == 0) &&
        curWin &&
        !dontFind
      ) {
        if (!body) return null;
        ...
        function checkElement(ele) {
          ...
          if (curHeight / bodyHeight <= 0.22) {
            ...
            if (article && article.length == 1) {
              ...
              self.curSiteRule.pageElement =
                article.nodeName.toLowerCase() +
                (article.id ? "#" + article.id : "") +
                (article.className ? "." + article.className.replace(/ /g, ".") : "") +
                ">*";
              debug(self.curSiteRule.pageElement, "Page element");
          ...
          let i,
            minHeight = curHeight * 0.52,
            curMaxEle = null,
            curMaxArea = 0,
            minWidth = Math.min(curWidth * 0.38, 500);
          let isHori,
            preOffsetTop = -1;
          let articleNum = 0;
          for (i = 0; i < ele.children.length; i++) {
            ...
            if (
              !/^IMG$/i.test(curNode.nodeName) &&
              curNode.querySelector("img") == null &&
              /^\s*$/.test(curNode.innerText)
            )
              continue;
            ...
            isHori =
              Math.abs(preOffsetTop - curNode.offsetTop) <= 20
                ? true
                : preOffsetTop == -1 &&
                  curNode.nextElementSibling &&
                  curNode.nextElementSibling.offsetTop == curNode.offsetTop;
            ...
            if (isHori) {
              ...
              if (
                curMaxEle &&
                curMaxEle.offsetParent == curNode.offsetParent &&
                curMaxEle.offsetTop == curNode.offsetTop
              ) {
            ...
            if (curMaxEle.className) {
              for (i = 0; i < ele.children.length; i++) {
                ...
                if (
                  ...
                  curMaxEle.className == curNode.className &&
                  curMaxEle.nodeName == curNode.nodeName
                ) {
                  sameClassNum++;
          ...
          if (ele.parentNode.children.length == 1 && curWin.getComputedStyle(ele.parentNode).float == "none")
            ele = ele.parentNode;
              ...
              if (!hasText) {
                ...
                if (gridArea && gridArea != "auto / auto / auto / auto") {
                  ...
                  if (curStyle.display === "flex" || (rulesData.opacity != 0 && !pf)) {
                    ...
                    (middleChild.style &&
                      middleChild.style.position === "absolute" &&
                      middleChild.style.left &&
                      middleChild.style.top) ||
                    /^UL$/i.test(ele.nodeName) ||
                    curHeight == 0
                  ) {
                    ele = [ele];
                  } else {
    ...
    changeVisibility() {
      ...
      let tempIndex = this.visibleIndex,
        findVisible = false,
        lastVisible = 0;
      let viewPortHeight =
        window.innerHeight || document.documentElement.clientHeight || getBody(document).clientHeight;
    ...
    async getPage(doc, exist) {
        ...
        for (i = aTags.length - 1; i >= 0; i--) {
          ...
          if (aTag.parentNode) {
            ...
            if (aTag.parentNode.parentNode) {
              ...
              if (
                ...
                /slick|slide|gallery/i.test(aTag.parentNode.parentNode.parentNode.className)
              )
                continue;
            }
          ...
          if (innerText) {
            ...
            if (innerText && innerText.length <= 25) {
              ...
              if (!next4) {
                if (!next2) {
                  if (
                    nextTextReg2.test(innerText) ||
                    /nextpage|pager\-older/i.test(aTag.className) ||
                    /^(»|>>)$/.test(innerText)
                  ) {
                    if (isJs) {
          ...
          if (!next4) {
            ...
            if (prevEle && /^(B|SPAN|STRONG)$/i.test(prevEle.nodeName)) {
              if (
                /^\d+$/.test(aTag.innerText.trim()) &&
                /^\d+$/.test(prevEle.innerText.trim()) &&
                parseInt(aTag.innerText) == parseInt(prevEle.innerText) + 1
              ) {
                next4 = aTag;
              }
            }
      ...
      if (next && next.classList && (next.classList.contains("results-more") || next.classList.contains("no")))
        next = null;
    ...
    getLinkByPage(url, pageNum) {
      ...
      return url
        .replace(/([&\/\?](p=|page[=\/_-]?))\d+/i, "$1" + pageNum)
    ...
    async getNextLink(doc, exist) {
      ...
      if (this.curSiteRule.pageElementByJs) {
        ...
        try {
          let over = (_url) => {};
          let targetUrl = await (typeof _unsafeWindow.pagetualNextLinkByJs == "undefined"
            ? new AsyncFunction("doc", '"use strict";' + this.curSiteRule.nextLinkByJs)
            : _unsafeWindow.pagetualNextLinkByJs)(doc);
          if (targetUrl) nextLink = { href: targetUrl };
        } catch (e) {
          debug(e);
        }
      } else if (this.curSiteRule.nextLinkByUrl) {
        let targetUrl = this.curUrl.replace(
        ...
        if (
          nextLink &&
          (this.curSiteRule.action == 0 || this.curSiteRule.action == 1 || this.curSiteRule.action == 2)
        ) {
        ...
        if (nextLink) {
          ...
          while (parent && !/^BODY$/i.test(parent.nodeName)) {
            ...
            if (parent.className && parent.classList) {
              if (
                parent.classList.contains("noClick") ||
                parent.classList.contains("no-pages") ||
      ...
      if (nextLink) {
        ...
        if (this.curSiteRule.action == 3) {
          ...
          if (needUrl && (href === "" || href === null)) {
            ...
            if (
              tempUrl != "#" &&
              (this.compareUrl(tempUrl, this.initUrl) ||
                this.compareUrl(tempUrl, this.curUrl) ||
                this.compareUrl(tempUrl, this.curUrl + "#") ||
                this.compareUrl(tempUrl, this.oldUrl) ||
                this.compareUrl(tempUrl, this.oldUrl + "#"))
            ) {
              this.nextLinkHref = false;
            } else if (doc == document) {
    ...
    checkStopSign(nextLink, doc) {
      if (this.curSiteRule.stopSign) {
        ...
        let typeObject =
          !typeArray &&
          (this.curSiteRule.stopSign.include || this.curSiteRule.stopSign.exclude || this.curSiteRule.stopSign.pageNum);
        if (typeArray || typeObject) {
          ...
          try {
            let stopSign = (
              typeof _unsafeWindow.stopSign == "undefined"
                ? Function("doc", "nextLink", '"use strict";' + this.curSiteRule.stopSign)
                : _unsafeWindow.stopSign
            )(doc, nextLink);
            if (stopSign) {
              isPause = true;
              this.nextLinkHref = false;
    ...
    preload() {
      ...
      _GM_xmlhttpRequest({
        ...
        headers: {
          ...
          "Content-Type":
            (postParams ? "application/x-www-form-urlencoded" : "text/html") +
            ";charset=" +
    ...
    getInsert(refresh) {
      ...
      if (this.curSiteRule.insert) {
        ...
        if (pageElement && pageElement.length > 0) {
          ...
          this.insert = pELast.nextSibling
            ? pELast.nextSibling
            : pELast.parentNode.appendChild(document.createTextNode(" "));
        }
      }
      return this.insert;
    }
    ...
    pageInit(doc, eles) {
      ...
      if (code) {
        let initFunc =
          typeof _unsafeWindow.pagetualPageInit == "undefined"
            ? Function("doc", "eles", '"use strict";' + code)
            : _unsafeWindow.pagetualPageInit;
    ...
    pageAction(doc, eles) {
      ...
      if (code) {
        try {
          (typeof _unsafeWindow.pagetualPageAction == "undefined"
            ? Function("doc", "eles", '"use strict";' + code)
            : _unsafeWindow.pagetualPageAction)(doc, eles);
        } catch (e) {
          debug(e);
        }
      }
      ...
      if (openInNewTab) {
        [].forEach.call(eles, (ele) => {
          if (/^A$/i.test(ele.nodeName) && ele.href && !/^(mailto:|javascript:)|#/.test(ele.href)) {
            ...
            [].forEach.call(
              ele.querySelectorAll('a[href]:not([href^="mailto:"]):not([href^="javascript:"]):not([href^="#"])'),
              (a) => {
                if (openInNewTab == 1) {
    ...
    lazyImgAction(eles) {
      ...
      let setLazyImg = (img) => {
        ...
        if (!realSrc) {
          ...
          if (!realSrc && img.srcset) {
            lazyAttr = "srcset";
            var srcs = img.srcset.split(/[xw],/i),
              largeSize = 0;
            srcs.forEach((srci) => {
              let srcInfo = srci.trim().split(" "),
                curSize = parseInt(srcInfo[1]);
      ...
      [].forEach.call(eles, (ele) => {
        if (/^IMG$/i.test(ele.nodeName)) {
          ...
          [].forEach.call(
            ele.querySelectorAll("div[data-src][data-thumb],div.img[data-src],div.lazy[data-src]"),
            (div) => {
    ...
    initPage(callback) {
      ...
      this.getRule(async () => {
        ...
        if (self.curSiteRule.singleUrl) {
          ...
          self.smartRules = self.smartRules.filter((item) => {
            return item && item.url != self.curSiteRule.url;
          });
        ...
        if (code) {
          try {
            (typeof _unsafeWindow.pagetualInit == "undefined"
              ? new AsyncFunction("doc", "win", "iframe", "click", "enter", "input", '"use strict";' + code)
              : _unsafeWindow.pagetualInit)(
              null,
              null,
              null,
              (sel) => {
                clickAction(sel, document);
              },
              (sel) => {
                enterAction(sel, document);
              },
              (sel, v) => {
                inputAction(sel, v, document);
              }
            );
          } catch (e) {
            debug(e);
    ...
    async insertPage(doc, eles, url, callback, tried) {
      ...
      if (this.curSiteRule.pageBarText) {
        if (this.curSiteRule.pageBarText == 1 || this.curSiteRule.pageBarText == true) {
          ...
          try {
            this.nextTitle = (
              typeof _unsafeWindow.pagetualPageBarText == "undefined"
  ...
  class Picker {
    ...
    init() {
      ...
      frame.innerHTML = createHTML(`
                ...
                <div>
                  <textarea class="selector" spellcheck="false" name="selector" placeholder="${i18n(
                    "pickerPlaceholder"
                  )}"></textarea>
                ...
                <button id="nextSwitch" class="command" title="${i18n("nextSwitch")}" type="button">${i18n(
        "nextSwitch"
      )}</button>
                <button id="loadNow" class="command" title="${i18n("loadNow")}" type="button">${i18n(
        "loadNow"
      )}</button>
      ...
      autoScrollBtn.addEventListener(
        "click",
        (e) => {
          self.close();
      ...
      addNextSelector.addEventListener(
        "click",
        (e) => {
          let editTemp = self.getTempRule();
          if (!editTemp) return;
      ...
      addPageSelector.addEventListener(
        "click",
        (e) => {
          let editTemp = self.getTempRule();
          if (!editTemp) return;
      ...
      showDetailBtn.addEventListener(
        "click",
        (e) => {
      ...
      nextSwitchBtn.addEventListener(
        "click",
        (e) => {
          self.close();
          nextSwitch.start();
        ...
        try {
          ...
          if (detail) {
            ...
            if (pos) {
              pos = parseInt(pos[1]);
              this.tempRule.value =
                this.tempRule.value.slice(0, pos) +
                "➡️" +
                this.tempRule.value[pos] +
                "⬅️" +
                this.tempRule.value.slice(pos + 1);
            }
  ...
  function initConfig(href) {
    ...
    class Rulebar {
      ...
      del() {
        if (this.ruleUrl.id < 2) {
          ...
          storage.setItem("rulesData", rulesData);
          ruleParser.rules = ruleParser.rules.filter((item) => {
            return item.from != this.ruleUrl.id;
          });
    ...
    let pastDate = new Date(updateDate).toString(),
      passStr;
    ...
    let enableHistoryAfterInsertInput = createCheckbox(
      i18n("enableHistoryAfterInsert"),
      rulesData.enableHistoryAfterInsert === true
    );
    ...
    let hideBarInput = createCheckbox(
      i18n("hideBar"),
      rulesData.hideBar && !rulesData.hideBarButNoStop,
      "h4",
      dbClick2StopInput,
      "radio"
    );
    hideBarInput.name = "hideBar";
    let hideBarButNoStopInput = createCheckbox(
      i18n("hideBarButNoStop"),
      rulesData.hideBarButNoStop,
      "h4",
      dbClick2StopInput,
      "radio"
    );
    ...
    hideBarButNoStopInput.addEventListener("mouseup", (e) => {
      if (hideBarButNoStopInput.checked) {
        setTimeout(() => {
          hideBarButNoStopInput.checked = false;
        }, 0);
      }
    });
    ...
    let dbClick2StopCtrlInput = createCheckbox(
      i18n("dbClick2StopCtrl"),
      rulesData.dbClick2StopCtrl,
      "h4",
      dbClick2StopInput
    );
    let dbClick2StopAltInput = createCheckbox(
      i18n("dbClick2StopAlt"),
      rulesData.dbClick2StopAlt,
      "h4",
      dbClick2StopInput
    );
    let dbClick2StopShiftInput = createCheckbox(
      i18n("dbClick2StopShift"),
      rulesData.dbClick2StopShift,
      "h4",
      dbClick2StopInput
    );
    let dbClick2StopMetaInput = createCheckbox(
      i18n("dbClick2StopMeta"),
      rulesData.dbClick2StopMeta,
      "h4",
      dbClick2StopInput
    );
    let dbClick2StopKeyInput = createCheckbox(
      i18n("dbClick2StopKey"),
      rulesData.dbClick2StopKey,
      "h4",
      dbClick2StopInput,
      "key"
    );
    ...
    customRulesTitle.innerHTML = i18n(
      "customRules",
      /tree/.test(location.href)
        ? location.href.replace("tree", "edit").replace(/\/$/, "") + "/pagetualRules.json"
      ...
      try {
        ...
        if (pos && !editor) {
          ...
          customRulesInput.value =
            customRulesInput.value.slice(0, pos) +
            "➡️" +
            customRulesInput.value[pos] +
            "⬅️" +
            customRulesInput.value.slice(pos + 1);
        }
        showTips(i18n("errorJson"));
        return;
      }
  ...
  function isVisible(el, win) {
    ...
    var loopable = true,
      visible =
        el.nodeName && win.getComputedStyle(el).display != "none" && win.getComputedStyle(el).visibility != "hidden";
  ...
  function globMatch(first, second) {
    ...
    if ((first.length > 1 && first[0] == "?") || (first.length != 0 && second.length != 0 && first[0] == second[0])) {
      return globMatch(first.substring(1), second.substring(1));
    }

    if (first.length > 0 && first[0] == "*") {
      return globMatch(first.substring(1), second) || globMatch(first, second.substring(1));
    }
  ...
  function initRules(callback) {
    storage.getItem("rulesData", (data) => {
      ...
      ruleParser.initSavedRules(() => {
        let upBtnImg = rulesData.upBtnImg,
          downBtnImg = rulesData.downBtnImg,
          _sideControllerIcon = rulesData.sideControllerIcon;
        ...
        if (upBtnImg) {
          upSvg = /https?:|data/.test(upBtnImg)
            ? `<img class="pagetual" src="${upBtnImg}"/>`
            : `<span>${upBtnImg}</span>`;
        }
        if (downBtnImg) {
          downSvg = /https?:|data/.test(downBtnImg)
            ? `<img class="pagetual" src="${downBtnImg}"/>`
            : `<span>${downBtnImg}</span>`;
        }
        if (_sideControllerIcon) {
          sideControllerIcon = /https?:|data/.test(_sideControllerIcon)
            ? `<img class="pagetual" src="${_sideControllerIcon}"/>`
            : `<span>${_sideControllerIcon}</span>`;
        }
    ...
    _GM_xmlhttpRequest({
      ...
      onload: async function (res) {
        ...
        if (inCors && (!pageElement || pageElement.length == 0) && ruleParser.curSiteRule.singleUrl) {
          ...
          if (article && article.length == 1) {
            article = article[0];
            ruleParser.curSiteRule.pageElement =
              article.nodeName.toLowerCase() +
              (article.id ? "#" + article.id : "") +
              (article.className ? "." + article.className.replace(/ /g, ".") : "") +
              ">*";
        ...
        if (
          pageElement &&
          (pageElement.length > 1 || (pageElement.length == 1 && !/^IMG$/i.test(pageElement[0].nodeName)))
        ) {
  ...
  function initView() {
    if (!mainStyleStyle) {
      mainStyleStyle = `
        ...
        `;
      let bodyColor;
      pageBarStyle = `overflow: visible;text-indent: initial;vertical-align: super;line-height:1;opacity:${
        rulesData.opacity
      };display:${
        rulesData.opacity == 0 ? "none" : "inline-flex"
      };padding:0;font-size: 30px;visibility: visible; position: relative; width: auto; max-width: 100vw; height: 30px; float: none; clear: both; margin: 5px auto; text-align: center;justify-content: center;box-sizing: content-box;${
        rulesData.opacity == 1
          ? "border-top: 1px solid rgb(80, 80, 80);"
          : "box-shadow: 0px 0px 10px 0px #000000aa;border-radius: 20px;background-color: rgb(240 240 240 / 80%);"
      }`;
    }
  ...
  function setLoadingDiv(loadingText) {
    loadingDiv.innerHTML = createHTML(
      `<p class="pagetual_loading_text" style="${loadingCSS}display: inline-block;width: 100%;">${loadingText}</p>${
        rulesData.hideLoadingIcon
          ? ""
          : `<div class="pagetual_loading"><svg width="50" height="50" style="position:relative;cursor: pointer;width: 50px;height: 50px;vertical-align: middle;fill: currentColor;overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M296 440c-44.1 0-80 35.9-80 80s35.9 80 80 80 80-35.9 80-80-35.9-80-80-80z" fill="#6e6e6e"></path><path d="M960 512c0-247-201-448-448-448S64 265 64 512c0 1.8 0.1 3.5 0.1 5.3 0 0.9-0.1 1.8-0.1 2.7h0.2C68.5 763.3 267.7 960 512 960c236.2 0 430.1-183.7 446.7-415.7 0.1-0.8 0.1-1.6 0.2-2.3 0.4-4.6 0.5-9.3 0.7-13.9 0.1-2.7 0.4-5.3 0.4-8h-0.2c0-2.8 0.2-5.4 0.2-8.1z m-152 8c0 44.1-35.9 80-80 80s-80-35.9-80-80 35.9-80 80-80 80 35.9 80 80zM512 928C284.4 928 99 744.3 96.1 517.3 97.6 408.3 186.6 320 296 320c110.3 0 200 89.7 200 200 0 127.9 104.1 232 232 232 62.9 0 119.9-25.2 161.7-66-66 142.7-210.4 242-377.7 242z" fill="#6e6e6e"></path></svg></div>`
      }`
    );
  }
  ...
  function getPageBar() {
    ...
    for (let i = 0; i < pageBars.length; i++) {
      ...
      let { top, right, bottom, left } = pageBar.getBoundingClientRect();
      if (top > 500) {
        nextBar = pageBar;
  ...
  function listenUrl() {
    ...
    var checkFunc = () => {
      ...
      if (
        (prevPathname !== window.location.pathname || prevSearch !== window.location.search) &&
        window.location.href != ruleParser.historyUrl
      ) {
        checkUrlTime = 2000;
  ...
  function initListener() {
    ...
    clickMode =
      typeof ruleParser.curSiteRule.clickMode == "undefined" ? rulesData.clickMode : ruleParser.curSiteRule.clickMode;
    ...
    dblclickHandler = (e) => {
      ...
      if (!rulesData.dbClick2StopKey) {
        if (
          (rulesData.dbClick2StopCtrl && !e.ctrlKey) ||
    ...
    let manualMode =
      typeof ruleParser.curSiteRule.manualMode == "undefined"
        ? rulesData.manualMode
        : ruleParser.curSiteRule.manualMode;
    if (manualMode) {
  ...
  const defaultLoadmoreSel =
    ".loadMore,.LoadMore,[class*='load-more'],button.show_more,.button-show-more,button[data-testid='more-results-button'],#btn_preview_remain";
  ...
  function createPageBar(url) {
    ...
    if (posEle) {
      ...
      bottomGap =
        ...
        (window.innerHeight || document.documentElement.clientHeight) *
          (ruleParser.curSiteRule.rate || rulesData.rate || 1);
    ...
    if (forceState == 2) {
      ...
      inTable =
        /^(TABLE|TBODY)$/i.test(example.parentNode.nodeName) ||
      ...
      inLi =
        /^LI$/i.test(example.nodeName) ||
        (example.nextElementSibling && /^LI$/i.test(example.nextElementSibling.nodeName));
    }
    ...
    if (forceState == 2) {
      ...
      pageBar.style.width =
        parentWidth - parseInt(parentStyle.paddingLeft) - parseInt(parentStyle.paddingRight) - 10 + "px";
    ...
    if (ruleParser.curSiteRule.pageBar && ruleParser.curSiteRule.pageBar !== 0) {
      try {
        (typeof _unsafeWindow.pagetualPageBar == "undefined"
          ? Function("pageBar", '"use strict";' + ruleParser.curSiteRule.pageBar)
          : _unsafeWindow.pagetualPageBar)(pageBar);
      } catch (e) {
        debug(e);
      }
    }
    ...
    if (ruleParser.curSiteRule.waitElement) {
      ...
      if (isNaN(ruleParser.curSiteRule.wait)) {
        try {
          checkEval =
            typeof _unsafeWindow.pagetualWait == "undefined"
              ? Function("doc", '"use strict";' + ruleParser.curSiteRule.wait)
              : _unsafeWindow.pagetualWait;
        } catch (e) {
          debug(e);
        }
  ...
  function emuPage(callback) {
    ...
    async function checkPage() {
      ...
      if (!orgPage) {
        if (!loadmoreEnd) {
          ...
          if (loadmoreBtn && isVisible(loadmoreBtn, emuIframe.contentWindow)) {
            ...
            let intv = setInterval(() => {
              ...
              if (
                !loadmoreBtn ||
                !getBody(document).contains(loadmoreBtn) ||
                !isVisible(loadmoreBtn, emuIframe.contentWindow)
              ) {
                clearInterval(intv);
                loadmoreEnd = true;
                setTimeout(() => {
        ...
        while (
          pageEle &&
          ((pageEle.scrollHeight && pageEle.scrollHeight < 50) ||
            !pageEle.offsetParent ||
            (!/^IMG$/i.test(pageEle.nodeName) && !pageEle.innerHTML.trim()))
        ) {
      ...
      let eles = ruleParser.getPageElement(iframeDoc, emuIframe.contentWindow, true),
        checkItem;
      if (eles && eles.length > 0) {
        checkItem = eles;
        ...
        while (
          checkItem &&
          ((checkItem.scrollHeight && checkItem.scrollHeight < 50) ||
            !checkItem.offsetParent ||
            (!/^IMG$/i.test(checkItem.nodeName) && !checkItem.innerHTML.trim()))
        ) {
        ...
        setTimeout(() => {
          try {
            ...
            if (
              ...
              notSetSandbox &&
              emuIframe.hasAttribute("sandbox")
            ) {
          ...
          if (code) {
            try {
              new AsyncFunction("doc", "win", "iframe", "click", "enter", "input", '"use strict";' + code)(
                iframeDoc,
                emuIframe.contentWindow,
                emuIframe,
                (sel) => {
                  clickAction(sel, iframeDoc);
                },
                (sel) => {
                  enterAction(sel, iframeDoc);
                },
                (sel, v) => {
                  inputAction(sel, v, iframeDoc);
                }
              );
            } catch (e) {
              debug(e);
  ...
  function isTouchViewPort(element) {
    ...
    return top < viewHeight && left < viewWidth && right > 0 && bottom > 0;
  }
  ...
  async function nextPage() {
    if (
      typeof ruleParser.curSiteRule.manualMode == "undefined" ? rulesData.manualMode : ruleParser.curSiteRule.manualMode
    )
      return;
    if (clickMode) return;
    ...
    if (ruleParser.curSiteRule.delay) {
      try {
        let checkDelay = (
          typeof _unsafeWindow.pagetualDelay == "undefined"
            ? Function('"use strict";' + ruleParser.curSiteRule.delay)
            : _unsafeWindow.pagetualDelay
        )();
    ...
    if (insert) {
      ...
      setTimeout(() => {
        if (ruleParser.curSiteRule.pageElementByJs) {
          ...
          try {
            (typeof _unsafeWindow.pagetualPageElementByJs == "undefined"
              ? Function("over", "pageNum", '"use strict";' + ruleParser.curSiteRule.pageElementByJs)
              : _unsafeWindow.pagetualPageElementByJs)(over, curPage);
          } catch (e) {
            debug(e);
          }
